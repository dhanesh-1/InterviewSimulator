...
* **Step 1: Smart Resume Parsing** 
  "The journey starts in the Dashboard. As a user, I can upload my latest resume in PDF or DOCX format. Instead of just saving the file, the backend uses OpenAI to parse it and extract my actual skills, education, and past experiences."
...
* **Step 4: Real-Time AI Evaluation**
  "Once I finish speaking, my answer is immediately sent to OpenAI for evaluation. It scores me on three metrics: Relevance, Clarity, and Confidence. It doesn't just give me a number; it provides detailed, constructive feedback on what I said and suggestions on how I could have phrased my answer better."
...
* **The AI Engine:** At the core of the parsing, question generation, and evaluation is the OpenAI Node SDK, utilizing the fast `gpt-5.4-mini` model."
