  ...
  return (
    <div className="page-container">
      <div className="dashboard-header">
        ...
        <Link to="/recruiter/post-job" className="btn btn-primary" id="recruiter-post-job-btn">
      ...
      <div className="dashboard-section">
        <div className="dashboard-section-header">
          ...
          <Link to="/recruiter/listings" className="btn btn-secondary btn-sm">
        ...
        {loading ? (
          ...
          <div className="empty-state" style={{ padding: '3rem' }}>
            ...
            <Link to="/recruiter/post-job" className="btn btn-primary" style={{ marginTop: '1rem' }}>
              Post First Job
            </Link>
          </div>
        ) : (
            ...
            {jobs.slice(0, 5).map(job => (
              <div key={job._id} className="recruiter-job-row glass-card">
                ...
                <div className="recruiter-job-meta">
                  ...
                  <Link to={`/recruiter/listings/${job._id}/applicants`} className="btn btn-secondary btn-sm">
                    View Applicants
                  </Link>
                </div>
              </div>
