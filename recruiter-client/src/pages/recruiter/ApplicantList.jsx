...
export default function ApplicantList() {
  ...
  return (
    <div className="page-container">
      <button className="btn btn-secondary btn-sm" onClick={() => navigate('/listings')} style={{ marginBottom: '1.5rem' }}>
                ...
                <div key={app._id} className="applicant-card glass-card">
                  ...
                  <div className="applicant-actions">
                    {app.status === 'completed' && (
                      <>
                        <Link to={`/applicants/${app._id}`} className="btn btn-secondary btn-sm">
